...
<body>
	...
	<div id="table">
	<center>
		<c:if test="${empty listOfFiles}">
			<p>Za odabrani auto ne postoje slike</p>
		</c:if>		
		<c:forEach items="${listOfFiles}" var="image">
			<a target="_blank" href="data:image/png;base64,${image}"><img
				src="data:image/png;base64,${image}" class="img"/> </a>
		</c:forEach></center>
	</div>
</body>
</html>