		...
		<sf:form action="createContract.html" method="POST"
			...
			<table style="width: 100%">
				...
				<tr>
					...
					<td>Datum rođenja:</td>
					<fmt:formatDate pattern="dd.MM.yyyy." value="${customer.dob}"
						var="dob" />
				...
				<tr>
					...
					<td>Grad:</td>
					<td><sf:input path="customer.city" value="${customer.city}" /></td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					...
					<td>Email:</td>
					<td><sf:input path="customer.email" value="${customer.email}" /></td>
					<td>Broj telefona:</td>
				...
				<tr class="showRow">
					<td>Gps:</td>
					<td><form:checkbox path="accessories.gps"
							style="margin-bottom: 3px;" /></td>
					<td>Wifi:</td>
					<td><form:checkbox path="accessories.wifi"
							style="margin-bottom: 3px;" /></td>
					<td>Sjedalica za dijete:</td>
					<td><form:checkbox path="accessories.babySeat"
							style="margin-bottom: 3px;" /></td>
				</tr>
				<tr>
					<td></td>
				...
				<tr class="showRow">
					...
					<td><form:checkbox path="accessories.oneWayFee"
							style="margin-bottom: 3px;" /></td>
					<td>Dodatni vozač:</td>
					<td><form:checkbox path="accessories.additionalDriver"
							style="margin-bottom: 3px;" /></td>
				</tr>
				<tr>
					<td></td>
